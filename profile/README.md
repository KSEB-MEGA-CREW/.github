...
🌐 ["수담(手談) 바로가기"](http://mega-crew-react-deploy.s3-website.ap-northeast-2.amazonaws.com)
...
- 일일 평균 정답률을 달력을 통해 월별, 주별로 비교 가능하도록 통계 시각적 제공

### 5. 사용자 경험 향상을 위한 게시판 기능
- 주 예상 사용자인 농인들의 사용자 경험을 개선하기 위한 게시판 서비스
- 관리자 계정을 통해 답변을 제공
